  ...
  <div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-md-4">
          <div class="section-header"><h2><?php echo $tag; ?></h2></div>
        </div>
   ...
   <?php 
    if(isset($productosByTag)):
      $i = 0;
      $totalCol = round(count($productosByTag) / 3);
      ?>
      ...
      foreach ($productosByTag as $prod):
      ...
      <div class="col-lg-4 grid-products" <?php echo $tagTipoString; ?> >
        <a href="<?php echo base_url() . $prod->slug;?>"><img src="<?php echo base_url();?>assets/uploads/<?php echo $prod->foto1; ?>" class="img-responsive" alt="<?php echo $prod->nombre; ?>" width="100%"></a>
