...
jQuery(document).ready(function($) {
  ...
  $('#submit').click(function() {
    ...
    if (ferror) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('contacto/sendEmail'); ?>",
        data: str,
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-4">
              <div class="section-header"><h2>Contacto</h2></div>
            </div>
        ...
        <div class="row">
          <div class="">
            <div class="box wow fadeInDown">
              <img src="<?php echo base_url();?>assets/img/contacto.jpg" class="img-responsive" width="100%">
            </div>
          </div>
        </div>
        ...
        <div class="space35"></div>
         ...
         <div class="row catalogoDescarga wow fadeInUp">
            <div class="col-lg-4 offset-lg-4">
              <img src="<?php echo base_url();?>assets/img/contacto01.png" alt="Catalogo" class="img-responsive" width="100%">
            </div>
        ...
        <div class="form col-lg-8 offset-lg-2">
          ...
          ?>
              <div class="form-group">
               ...
               <div class="form-group">
                <span>E-mail</span>
                <input type="email" class="form-control" name="email" id="email" data-rule-email="true" data-msg-email="Please enter a valid email" />
                <div class="validation"></div>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <span>ASUNTO</span>
                <input type="text" class="form-control" name="asunto" id="asunto" data-rule="minlen:4" data-msg="Por favor ingrse al menos 4 caracteres" />
                <div class="validation"></div>
              </div>
...
<!-- script src="<?php //echo base_url();?>assets/lib/contactform/contactform.js"></script -->