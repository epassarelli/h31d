...
class Categorias extends MY_Controller
{
    ...
    public function index()
    {
		...
		// Show in
		$crud->add_fields(["name", "image", "image2", "slug"]);
		$crud->edit_fields(["name", "image", "image2", "slug"]);
		$crud->columns(["name", "image", "image2", "slug"]);
		...
		$crud->set_rules("image2", "Imagen Cuadrada", "required");
		
		// Display As
		$crud->display_as("name", "Descripcion");
		$crud->display_as("image", "Imagen");
		$crud->display_as("image2", "Imagen Cuadrada");
