...
class Catalogo extends MY_Controller{
	...
	public function sendEmail(){
	    ...
	    $sql = '<p align=\"left\">Nombre: '.$_POST['nombre'].'</p>
	    <p align=\"left\">Negocio: '. $_POST['negocio'] .'</p>
	    <p align=\"left\">Email: '. $_POST['email'] .'</p>
	    <p align=\"left\">Localidad: '. $_POST['localidad'] .'</p>';
