    ...
    <div class="social-auth-links text-center">
      ...
      <?php if ($features['disable_all_social_logins'] == false): ?>
        <?php if ($features['login_via_facebook']): ?>
          <a href="<?php echo $facebook; ?>" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> <?php echo lang('signin_using') ?> Facebook</a>
        <?php endif ?>
        <?php if ($features['login_via_google']): ?>
          <a href="<?php echo $google; ?>" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google"></i> <?php echo lang('signin_using') ?> Google+</a>
        <?php endif ?>
