...
<body class="hold-transition skin-<?php echo $this->config->item('skin') ?> fixed sidebar-collapse sidebar-mini">
    <!-- Site wrapper -->
    <div class="wrapper">  
        <header class="main-header">
            <a href="<?php echo site_url(); ?>" class="logo">
                <span class="logo-mini">
                    <img src="<?php echo site_url('assets/img/logo/m.png')?>" class="profile-user-img img-responsive" style="height:51" alt=""/>
                </span>
                <span class="logo-lg">
                    <img src="<?php echo site_url('assets/img/logo/m2.png')?>" class="img-responsive" style="align-content: center" alt="El Muro"/>
                </span>
            </a>
             ...
             <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="flag-icon flag-icon-<?php echo $this->session->userdata('lang_code') ? $this->session->userdata('lang_code') : 'es' ?>"></span> <?php echo lang('language') ?>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php //echo site_url('myigniter/sys_lang/english'); ?>"><span class="flag-icon flag-icon-us"></span> US English</a></li>
                                <li><a href="<?php //echo site_url('myigniter/sys_lang/spanish'); ?>"><span class="flag-icon flag-icon-es"></span> Spanish</a></li>
                            ...
                            <?php foreach ($menu['children'] as $menu2): ?>
                                <li <?php echo $menu2['attr'] != '' ? ' id="'.$menu2['attr'].'" ' : '' ?> <?php echo is_array($menu2['children']) ? ' class="treeview" ' : '' ?>>
                                    <?php if (is_array($menu2['children'])): ?>
                                        <a href="<?php echo $menu2['link'] != '#' ? strspn($menu2['link'], 'http') ? $menu2['link'] : base_url($menu2['link']) : '#' ?>" class="name">
                                        ...
                                        <ul class="treeview-menu">
                                            <?php foreach ($menu2['children'] as $menu3): ?>
                                                <li <?php echo $menu3['attr'] != '' ? ' id="'.$menu3['attr'].'" ' : '' ?>>
                                                    ...
                                                    <a href="<?php echo $menu3['link'] != '#' ? strspn($menu3['link'], 'http') ? $menu3['link'] : base_url($menu3['link']) : '#' ?>" class="name">
                                                    ...
                                                    <ul class="treeview-menu">
                                                        <?php foreach ($menu3['children'] as $menu4): ?>
                                                            <li <?php echo $menu4['attr'] != '' ? ' id="'.$menu4['attr'].'" ' : '' ?>>
                                                                <a href="<?php echo $menu4['link'] != '#' ? strspn($menu4['link'], 'http') ? $menu4['link'] : base_url($menu4['link']) : '#' ?>" class="name">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?php echo date('Y') ?> <a href="">HELD Argentina</a>.</strong> Todos los derechos reservados.
        </footer>
    </div><!-- ./wrapper -->
    <?php
