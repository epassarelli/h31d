...
class Pdfrecibo extends TCPDF
{
    ...
    public function Header() {
        ...
        switch ($this->tipofactura) {
            ...
            case 4:
                $this->SetFont('helvetica', '', 6);
                $this->MultiCell(0, 0, 'Recibo', $border=0, $align='C', $fill=0, $ln=1, $x=10, $y=26);
                break;
            case 6:
                $this->SetFont('helvetica', '', 10);
                $this->MultiCell(0, 0, 'Factura', $border=0, $align='C', $fill=0, $ln=1, $x=10, $y=26);
        ...
        $this->MultiCell(0, 10, 'Razón Social: Walco Electronica', $border=0, $align='L', $fill=0, $ln=1, $x=13, $y=24);
        $this->MultiCell(0, 10, 'Domicilio Comercial: H. Yrigoyen 78 - 2705 Rojas (B)', $border=0, $align='L', $fill=0, $ln=1, $x=13, $y=28);
        $this->MultiCell(0, 10, 'Condición frente al IVA: IVA Responsable Inscripto', $border=0, $align='L', $fill=0, $ln=1, $x=13, $y=32);
        $this->MultiCell(0, 10, 'Tel.: (02475) 462166 - Tel-Fax: (02475) 464769', $border=0, $align='L', $fill=0, $ln=1, $x=13, $y=36);
        $this->MultiCell(0, 10, 'Email: walcoelectronica@clyfer.com.ar', $border=0, $align='L', $fill=0, $ln=1, $x=13, $y=40);

        $this->MultiCell(0, 10, 'de Walter Mario Gazaba y Claudio Orlando Barraque', $border=0, $align='L', $fill=0, $ln=1, $x=115, $y=24);
        $this->MultiCell(0, 10, 'Cuit: 30-59527776-7', $border=0, $align='L', $fill=0, $ln=1, $x=115, $y=28);
        $this->MultiCell(0, 10, 'Ingresos Brutos Conv. Mult.: 902-876876-1', $border=0, $align='L', $fill=0, $ln=1, $x=115, $y=32);
        $this->MultiCell(0, 10, 'Fecha Inicio de Actividades: 01/08/1980', $border=0, $align='L', $fill=0, $ln=1, $x=115, $y=36);
        $this->MultiCell(0, 10, 'Jub. Aut.: CUIT 20-12232481-9 20-11906855-0', $border=0, $align='L', $fill=0, $ln=1, $x=115, $y=40);
        ...
        //$this->RoundedRect(10, 64, 190, 5, 3.50, '0000');
            $this->SetX(10);
            $this->SetY(68);
            $this->Cell(20, 4, ' Fecha Ingreso', 1, 0, 'L', 0, 0, 0, true);
            $this->Cell(120, 4, ' Descripcion', 1, 0, 'L', 0, 0, 0, true);
            $this->Cell(20, 4, ' Fecha Vencimiento', 1, 0, 'L', 0, 0, 0, true);
            $this->Cell(30, 4, ' Monto', 1, 0, 'L', 0, 0, 0, true);
    }
