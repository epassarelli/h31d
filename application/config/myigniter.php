...
$config['version'] = '4.0.3'; // myigniter version

// Site
$config['site'] = [
    'title' => 'Held', // Default Title entire page
...
// Template
$config['template'] = [
    'front_template' => 'template/auth_template', // Default front template
...
# black
# black-light
$config['skin'] = 'black-light'; // selected skin
